  ...
  return (
    <div className="legal-page">
      ...
      <div className="legal-content">
        ...
        <h2>1. Acceptance</h2>
        <p>By creating an account on Lockheart, you agree to these Terms of Service. If you do not agree, do not use the app.</p>

        <h2>2. Eligibility</h2>
        <p>You must be at least 18 years old to use Lockheart. By registering, you confirm you meet this requirement.</p>
        ...
        <h2>4. Conduct</h2>
        <p>Lockheart is built for genuine connections. You agree not to:</p>
        <ul>
        ...
        <h2>8. Disclaimers</h2>
        <p>Lockheart is provided "as is." We do not guarantee matches, connections, or outcomes. We are not responsible for the conduct of other users.</p>

        <h2>9. Changes</h2>
        <p>We may update these terms at any time. Continued use of Lockheart after changes constitutes acceptance.</p>

        <h2>10. Contact</h2>
        <p>Questions? Reach us at support@lockheartapp.com</p>
      </div>
    </div>
  );
};
