      ...
      <div className="report-modal modal-sheet" onClick={(e) => e.stopPropagation()}>
        {done ? (
          <div style={{ textAlign: 'center', padding: '24px 0' }}>
            ...
            <p style={{ fontSize: 14, opacity: 0.7, marginTop: 6 }}>Thank you for keeping Lockheart safe.</p>
          </div>
        ) : (
          <>
      ...
      <div className="modal-sheet exit-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <p className="modal-body">
          {metInPerson
            ...
            : "Your message will be sent directly to them. Unmatching without a thoughtful reason can lower your Lockheart score."}
        </p>
